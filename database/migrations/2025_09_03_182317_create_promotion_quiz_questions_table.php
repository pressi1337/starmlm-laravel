...
return new class extends Migration
{
    ...
    {
        Schema::create('promotion_quiz_questions', function (Blueprint $table) {
            $table->id();
            $table->integer('promotion_video_quiz_id')->nullable();
    ...
    {
        Schema::dropIfExists('promotion_quiz_questions');
    }
};
